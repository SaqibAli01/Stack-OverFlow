    ...
    <div>
      ...
      >
        ...
        >
          <Tabs
            ...
            sx={{ ...tabsLineNone }}
          >
            <Tab label="Activity" sx={{ ...tabStyles }} {...a11yProps(0)} />
            <Tab label="Offered" sx={{ ...tabStyles }} {...a11yProps(1)} />
            <Tab
              label="Earned"
      ...
      >
        <CustomTabPanel value={value} index={0} sx={{ p: 1 }}>
          ...
          >
            <Typography sx={{ textAlign: "center" }}>
              You have not <Link to="">bounties</Link>
            </Typography>
          </Box>
        </CustomTabPanel>
        ...
        <CustomTabPanel value={value} index={3}>
          ...
          >
            <Typography>You have not</Typography>
          </Box>
        </CustomTabPanel>
      </Box>
    </div>
