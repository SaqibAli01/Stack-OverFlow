        ...
        <Grid item xs={12} sm={5} md={3.5}>
          <Box>
            ...
            >
              ...
              >
                <Box>
                  <Text
                    sx={{
                      fontSize: { md: "13px", sm: "11px", xs: "9px" },
                    }}
                  >
                    1
                  </Text>
            ...
            >
              ...
              <Button sx={{ color: "#6a737c", textTransform: "none" }}>
                Edit
              </Button>
            </Box>
            <Box
            ...
            >
              ...
              >
                ...
                <Typography
                  sx={{
                    color: "#0a95ff",
                    fontSize: { md: "13px", sm: "9px", xs: "10px" },
                    fontWeight: 400,
                  }}
                >
                  Stack Overflow
          ...
          <Box>
            ...
            >
              ...
              >
                ...
                one?{" "}
                <Link to="" sx={{ color: "#0a95ff", textDecoration: "none" }}>
                  Edit profile
                </Link>
              </Typography>
            </Box>
                ...
                >
                  ...
                  >
                    <svg
                      fill="#ffcc00"
                      aria-hidden="true"
                      class="fc-gold svg-spot spotAward"
                      width="48"
                      height="48"
                      viewBox="0 0 48 48"
                    >
            ...
            >
              ...
              <Text
                sx={{ py: 2, fontSize: { md: "13px", sm: "11px", xs: "10px" } }}
              >
              ...
              <Text
                sx={{
                  px: { md: 20, sm: 2, xs: 1 },
                  textAlign: "center",
                  fontSize: { md: "13px", sm: "11px", xs: "10px" },
                }}
              >
                ...
                >
                  answering a question or selecting tags{" "}
                </Link>{" "}
